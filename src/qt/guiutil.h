...
/** Utility functions used by the RUPAYA Qt UI.
 */
namespace GUIUtil
{
...
// Render RUPAYA addresses in monospace font
...
// Parse "rupaya:" URI into recipient object, return true on successful parsing

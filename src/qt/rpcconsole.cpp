                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRUPXPathCustom = GetArg("-zrupxbackuppath", "");
    ...
    if(!strzRUPXPathCustom.empty()) {
        ui->wallet_customzrupxbackuppath->setText(QString::fromStdString(strzRUPXPathCustom));
        ui->wallet_customzrupxbackuppath_label->setVisible(true);
        ui->wallet_customzrupxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRUPXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Rupaya RPC console.") + "<br>" +

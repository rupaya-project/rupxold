...
/* Rupaya GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "RUPAYA"
#define QAPP_ORG_DOMAIN "rupx.io"
#define QAPP_APP_NAME_DEFAULT "RUPAYA-Qt"
#define QAPP_APP_NAME_TESTNET "RUPAYA-Qt-testnet"

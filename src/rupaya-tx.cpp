...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Rupaya Core rupaya-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rupaya-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rupaya transaction") + "\n" +
                               "  rupaya-tx [options] -create [commands]   " + _("Create hex-encoded rupaya transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rupaya transaction

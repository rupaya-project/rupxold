...
#   c) node1 mines 32 blocks, so now node 0 has 60001rupx, node 1 has 4250rupx, node2 has none.
#   d) node0 sends 601 rupx to node2, in two transactions (301 rupx, then 300 rupx).
